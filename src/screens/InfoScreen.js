    ...
    <ScrollView style={styles.container}>
      <View style={styles.contentContainer}>
        ...
        <View style={styles.cardContainer}>
          ...
          <Card title="More information" style={{ width: '100%' }}>
            ...
            >
              <>
                <Text>
                  ...
                  bijzonder voor alle jonge ouders die zich vertwijfeld afvragen
                  of hun kind elke drie maanden nieuwe kleren en nieuw speelgoed
                  nodig blijft hebben. Voor altijd gratis in het basisgebruik,
                  met volledige garantie op privacy van jou, als eindgebruiker.
                  (zie ons privacystatement). Niet bedoeld om zoveel mogelijk
                  clicks te genereren of je zo lang mogelijk in deze app te
                  houden, maar om je leven net een klein beetje eenvoudiger te
                  maken, je wat geld te besparen, en in de tussentijd ook nog
                  iets goeds te doen voor de planeet. Ben je er blij mee? Spread
                  the word. Je kunt ook een review achterlaten in de App Store.
                  En als je op of aanmerkingen hebt? Gebruik het
            ...
            >
              <>
                <Text>
                  ...
                  inschrijft, krijg je 100 nix, zomaar, gratis en voor niks. Als
                  je een product te ruilen aanbiedt, kun je er een waarde op
                  plakken. Zo kun je meer nix verzamelen; en die kun je dan weer
                  gebruiken om producten van anderen over te nemen. Zo kan de
                  ruilwaarde van de dingen worden uitgedrukt in nix.
                </Text>
            ...
            >
              <>
                <Text>
                  ...
                  op afstand. Deze gegevens, en alle andere gegevens die we over
                  jou verzamelen, worden enkel en alleen gebruikt om de app goed
                  te laten functioneren. Wij hebben verder geen enkel financieel
                  belang bij deze gegevens; je kunt de app anoniem gebruiken om
                  door de advertenties te bladeren, maar als je wat van de
                  andere functies wil proberen, moet je een account aanmaken.
                  Dat kan anoniem; het enige wat je van je nodig hebben, is een
                  email adres. Dat wordt verwijderd als je je account
                  verwijdert, en wordt voor geen enkel ander doel gebruikt dan
                  je af en toe te kunnen berichten als een andere gebruiker
                  contact met je zoekt of als er belangrijke systeem-informatie
                  is.
                </Text>
            ...
            >
              <>
                <Text>
                  ...
                  dat er nooit of te nimmer een bug of fout optreedt. Daarom kun
                  je geen rechten ontlenen aan deze app of de daarin
            ...
            >
              <>
                <Text>
                  PublicSpaces is een organisatie die zich ten doel stelt om het
                  publieke domein op het internet te versterken. Deze app is
                  gemaakt met de waarborgen van PublicSpaces in het achterhoofd.
                  Volledige transparantie is daarbij belangrijk. De broncode van
                  deze app is daarom openbaar, en kun je hier downloaden en
                  inzien.
                </Text>
            ...
            >
              <>
                <Text>
                  Design: Mirre Bogaerts{'\n'}Idea and development: GJ Bogaerts
                  {'\n'}
